/* ══════════════════════════════════════════════════════════════
   LIVEORDER PRO — app.js v5.0
   Architecture : State-driven · Progressive Steps · CRO-First
   Micro-interactions : Ripple · Count-up · Bump · Sidebar gate
══════════════════════════════════════════════════════════════ */
...
const DOM = {
  ...
  sbPayCta:   () => document.getElementById('sidebarStripeLink'),
...
function render() {
  ...
  if (ac) {
    ...
    if (hasProduct && !wasActive) {
      flashPriceCard(productPrice);
    }
  }
...
function resetAll() {
  ...
  if (DOM.submitBtnTxt()) { DOM.submitBtnTxt().style.opacity = '1'; DOM.submitBtnTxt().textContent = 'Valider ma commande'; }
